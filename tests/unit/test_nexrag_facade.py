...
class TestIngestBatch:
    ...
    def test_each_source_is_passed_to_ingest(self):
        ...
        pipeline._ingestion.ingest.assert_any_call("a.pdf", None, metadata=None, collection=None)
        pipeline._ingestion.ingest.assert_any_call("b.txt", None, metadata=None, collection=None)
    ...
    def test_loader_override_passed_to_each_ingest(self):
        ...
        pipeline._ingestion.ingest.assert_has_calls(
            [
                call("a.pdf", mock_loader, metadata=None, collection=None),
                call("b.pdf", mock_loader, metadata=None, collection=None),
            ]
        )
